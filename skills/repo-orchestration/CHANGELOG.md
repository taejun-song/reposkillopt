# Canonical Skill Changelog — repo-orchestration
...
- Initial release of the **repo-orchestration** skill (feature 019), part of the as-is → to-be → orchestrate
  extension. Vendor-neutral; reuses the existing Feedback Item / Skill Edit Proposal / validation-gate
  machinery; ships rubric dimensions (`rubric/orchestration*-rubric.md`) and deterministic checks
